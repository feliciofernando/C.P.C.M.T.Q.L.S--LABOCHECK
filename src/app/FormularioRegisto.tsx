...
export default function FormularioRegisto({ onSucesso }: FormularioRegistoProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!form.numeroBI.trim()) {
      toast.error('Nº do Bilhete de Identidade é obrigatório');
      return;
    }
    if (!form.sexo) {
    ...
    <form onSubmit={handleSubmit} className="space-y-8">
      ...
      <div className="bg-white border border-[#d1d1cc] rounded-lg p-4">
        <div className="flex items-center gap-3">
          ...
          <Input
            ...
            placeholder="Buscar por nome, Nº do B.I. ou Nº de Ordem..."
            className="flex-1"
          />
          <Button
            type="button"
      ...
      <div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          ...
          <div>
            <Label htmlFor="matriculaVeiculo">Nº da Matrícula</Label>
            <Input
              id="matriculaVeiculo"
          ...
          <div>
            <Label htmlFor="numeroCartaConducao">Nº da Carta de Condução</Label>
            <Input
      ...
      <div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 gap-3">
          {[
            ...
            { key: 'temCapacete', label: 'Capacete de Protecção' },
