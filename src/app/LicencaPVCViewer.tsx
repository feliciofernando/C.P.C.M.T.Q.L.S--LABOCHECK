          ...
          >
            ...
            <div style={{ borderBottom: '1px solid #d4a017', paddingBottom: '3px', paddingTop: '1px' }}>
              <p style={{
                ...
                LICENÇA PROFISSIONAL DE CONDUTOR
              </p>
            </div>
          </div>
          ...
          <div style={{ display: 'flex', padding: '8px 16px 4px', gap: '12px', flex: 1 }}>
            ...
            <div style={{ flex: 1, fontSize: '10.5px', lineHeight: '1.6', color: '#1a1a1a' }}>
              ...
              <p style={{ fontSize: '8.5px', lineHeight: '1.4' }}>
                <span style={labelStyle}>Membro Nº C.P.C.M.T.Q.L.S</span>
              </p>
              <p style={{ fontSize: '9px' }}>
                <span style={labelStyle}>{membro}</span>
              </p>
              <p><span style={labelStyle}>Categoria:</span> {categoria}</p>
              <p><span style={labelStyle}>Título:</span> Condutor Profissional</p>
        ...
        >
          ...
          >
            ...
            <p style={{
              ...
              deve-se acompanhar por um outro documento de Identificação sempre que
            ...
            <p style={{
              ...
              Decreto Presidencial Nº 245/15
            </p>
            ...
            <div style={{
              ...
              <p style={{
                ...
                &quot;Mototaxistas organizados, trânsito mais seguro&quot;
              </p>
