      ...
      <Card className="border-[#d1d1cc] dark:border-[#30363d]">
        ...
        <CardContent className="p-6 space-y-4">
          <p className="text-sm text-[#6b6b6b] dark:text-[#8b949e]">
            Escolha o tema visual para o painel administrativo. Esta opção é apenas para administradores
            e não afecta a página pública.
          </p>
      ...
      <Card className="border-[#d1d1cc] dark:border-[#30363d]">
        ...
        <CardContent className="p-6 space-y-5">
          <div className="space-y-3">
            <Label className="text-sm font-medium text-[#1a1a1a] dark:text-[#e6e6e1]">Pré-visualização</Label>
          ...
          <div className="bg-[#f8f8f5] dark:bg-[#1c2128] rounded-lg p-4 border border-[#d1d1cc] dark:border-[#30363d]">
            <div className="flex items-start gap-2">
              ...
              <div className="text-xs text-[#6b6b6b] dark:text-[#8b949e] space-y-1.5">
                <p className="font-semibold text-[#1a1a1a] dark:text-[#e6e6e1]">Recomendações para a imagem:</p>
                <ul className="list-disc list-inside space-y-0.5">
                  <li><strong>Dimensão mínima:</strong> 1920 x 600 pixels (ideal)</li>
                  ...
                  <li><strong>Conteúdo:</strong> Imagem institucional, paisagem urbana ou relacionada a motociclos/transporte</li>
                  <li><strong>Nota:</strong> A imagem será coberta por um overlay verde semi-transparente</li>
                </ul>
              </div>
            </div>
          </div>
