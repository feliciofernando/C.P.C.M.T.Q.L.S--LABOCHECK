...
export async function POST(request: NextRequest) {
  try {
    ...
    // Gerar QR Code com URL permanente — nunca mudar este dominio
    const QR_PERMANENT_URL = 'https://cpcmtqls.vercel.app';
    const qrData = `${QR_PERMANENT_URL}/?consulta=${encodeURIComponent(data.numeroBI)}`;
