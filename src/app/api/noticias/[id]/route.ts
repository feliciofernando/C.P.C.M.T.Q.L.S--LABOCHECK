...
export async function PUT(
  ...
  try {
    ...
    logActivity({ adminUsername: admin.username, adminNome: admin.nome, adminId: admin.id, acao: 'EDITAR_NOTICIA', categoria: 'NOTICIAS', detalhes: `Noticia "${tituloNoticia}" actualizada` }).catch(() => {});
...
export async function DELETE(
  ...
  try {
    ...
    logActivity({ adminUsername: admin.username, adminNome: admin.nome, adminId: admin.id, acao: 'ELIMINAR_NOTICIA', categoria: 'NOTICIAS', detalhes: `Noticia "${tituloNoticia}" eliminada` }).catch(() => {});
